...
public class FileService extends ServiceConfig {
  ...
  @Locale("ERROR_TITLE_FILE_READING_ERROR")
  private String errorTitleFileReading;
  ...
  public ResponseEntity<String> getTextFile(String path, String contentType) throws AWException {
    ...
    try {
      ...
      throw new AWException(errorTitleFileReading, getLocale(ERROR_MESSAGE_FILE_READING_ERROR, path), exc);
    }
