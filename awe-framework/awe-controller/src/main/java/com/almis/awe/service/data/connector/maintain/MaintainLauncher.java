...
public class MaintainLauncher extends ServiceConfig {
  ...
  public ServiceData launchMaintain(MaintainQuery maintain, DatabaseConnection connection, Map<String, QueryParameter> parameterMap) throws AWException {
    ...
    return maintainLauncher.launch(maintain, connection, parameterMap);
  }
