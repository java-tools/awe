describe('awe-framework/awe-client-angular/src/test/js/services/grid/commons.js', function() {
  ...
  it('should fix a column', function() {
    // Mock
    let component = {constants:{ROW_IDENTIFIER: "rowId"}, controller: {columnModel: []}, scope: {$on: () => null, charSize: 7}, enableSorting: true, listeners: {}, api: {}, model: {}, address: {view: "viewId", component: "componentId"}};
    ...
    expect(column.cellTemplate).toBe("<div class=\"ui-grid-cell-contents component {{col.cellClass}}\" title=\"TOOLTIP\" column-id=\"{{col.name}}\"><awe-column-text " +
      "cell-address='{\"hash\":\"{{row.uid}}\", \"view\":\"viewId\", \"component\":\"componentId\", \"row\":\"{{row.entity.rowId}}\", \"column\":\"{{col.name}}\"}'/></div>");
