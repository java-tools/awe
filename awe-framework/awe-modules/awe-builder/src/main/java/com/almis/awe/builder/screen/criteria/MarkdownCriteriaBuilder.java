...
public class MarkdownCriteriaBuilder extends AbstractCriteriaBuilder<MarkdownCriteriaBuilder, AbstractCriteria> {
  @Override
  public AbstractCriteria build() {
    return (AbstractCriteria) super.build(new Criteria())
      .setComponentType(Component.MARKDOWN_EDITOR.toString());
  }
}
