...
public class CheckboxCriteriaBuilder extends AbstractCriteriaBuilder<CheckboxCriteriaBuilder, AbstractCriteria> {

  private CheckboxRadioAttributes checkboxRadioAttributes;

  public CheckboxCriteriaBuilder() {
    super();
   ...
   * @return This
   */
  public CheckboxCriteriaBuilder setGroup(String group) {
   ...
   * @return This
   */
  public CheckboxCriteriaBuilder setChecked(boolean checked) {
