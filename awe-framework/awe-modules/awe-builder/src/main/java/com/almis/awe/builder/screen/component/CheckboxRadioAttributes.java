...
public class CheckboxRadioAttributes<B extends AbstractCriteriaBuilder> extends AbstractAttributes<B> {
  private String group;
  private boolean checked;

  public CheckboxRadioAttributes(B builder) {
    super(builder);
  }
   ...
   */
  public <E extends AbstractCriteria> E asCheckboxRadio(E element) {
    return (E) element
      .setGroup(getGroup())
