...
public class PasswordCriteriaBuilder extends AbstractCriteriaBuilder<PasswordCriteriaBuilder, AbstractCriteria> {
  @Override
  public AbstractCriteria build() {
    return (AbstractCriteria) super.build(new Criteria())
      .setComponentType(Component.PASSWORD.toString());
  }
}
