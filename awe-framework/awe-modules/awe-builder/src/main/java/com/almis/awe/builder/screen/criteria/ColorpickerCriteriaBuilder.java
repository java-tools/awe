...
public class ColorpickerCriteriaBuilder extends AbstractCriteriaBuilder<ColorpickerCriteriaBuilder, AbstractCriteria> {
  @Override
  public AbstractCriteria build() {
    return (AbstractCriteria) super.build(new Criteria())
      .setComponentType(Component.COLOR.toString());
  }
}
