...
--  DDL for Schema AWE
--------------------------------------------------------
CREATE SCHEMA IF NOT EXISTS AWE;
...
Insert into AweKey (KeyNam, KeyVal) values ('DbsKey', 1);
...
Insert into AweAppPar (IdeAweAppPar,ParNam,ParVal,Cat,Des,Act) values ('9','PwdMaxNumLog','3','1','Number of attempts to login','0');
...
Insert into AweAppPar (IdeAweAppPar,ParNam,ParVal,Cat,Des,Act) values ('19','DjrHdgPag','0','2','Remove heading and pagination when exporting to excel','1');
Insert into AweAppPar (IdeAweAppPar,ParNam,ParVal,Cat,Des,Act) values ('20','DjrBokTit','0','2','Include book in report title','1');
-- Update AppParKey
UPDATE AweKey SET KeyVal = '21' where KeyNam = 'AppParKey';

-- Insert default profiles
Insert into AwePro (IdePro, Acr, Nam, IdeThm, ScrIni, Res, Act) values ('1','ADM','Administrator','1',null,'administrator','1');

-- Update ProKey
UPDATE AweKey SET KeyVal = '2' where KeyNam = 'ProKey';
